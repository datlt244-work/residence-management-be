...
public class GetDepartmentAdminDetailHandler {

    private final DepartmentRepository departmentRepository;

    public DepartmentListItemDto handle(final String departmentId) {
        Department department = departmentRepository.findById(DepartmentId.of(departmentId))
                .orElseThrow(() -> new IllegalArgumentException("Department not found: " + departmentId));
        return DepartmentListItemDto.fromDomain(department);
    }
}
